...
class Logger(object):
    ...
    def __init__(self, log_dir, name=None, s_train='train'):
        ...
        if name is not None:
            try:
                if not os.path.isdir(os.path.join(log_dir, name, s_train)):
                    os.makedirs(os.path.join(log_dir, name, s_train))
                print("Training result is save to: " + os.path.join(log_dir, name, s_train))
            except:
                print("faill to mk logdir: "+ os.path.join(log_dir, name, s_train))
                pass
            self.writer = tf.summary.FileWriter(os.path.join(log_dir, name, s_train),
