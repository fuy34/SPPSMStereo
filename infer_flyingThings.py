...
parser.add_argument('--savepath', metavar='DIR', default= '/home/fuy34/Dropbox/disp_res/my_joint_sp4_flyingThings' ,
                    help='save path')
...
def main():
    ...
    print(
        '/home/fuy34/stereo_data/sceneflow//FlyingThings3D/frames_cleanpass//TEST/A/0083/left/0007.png' in test_left_img)
    print(
        '/home/fuy34/stereo_data/sceneflow//FlyingThings3D/frames_cleanpass//TEST/A/0145/left/0007.png' in test_left_img)
    exit(1)
    for inx in range(0, len(test_left_img), 40):

    # randIndice  = np.random.choice( range(len(test_left_img)), 100)
    # for inx in randIndice:
       ...
       top_pad   = args.input_img_height - imgL_o.shape[0]
