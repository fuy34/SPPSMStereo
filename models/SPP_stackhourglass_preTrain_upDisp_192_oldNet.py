...
from models.spixel_module_old import SpixelNet
from utils import *
...
class PSMNet(nn.Module):
    def __init__(self, args, spixel_ckpts, b_pretrain=False):
    ...
    def forward(self, left, right, disp_true=None, b_joint=False):
        ...
        if self.training and b_joint:
            ...
            # pooled_labxy = self.poolfeat(LABXY_featL_full, maskL_full_4, sz, sz)
            # reconstr_fea = self.upfeat(pooled_labxy, maskL_full_4, sz, sz)
        ...
        if self.training:
            ...
            return pred3,  maskL,  None, self.val_spix_idx_list#, (spImg_l, spImg_r)
