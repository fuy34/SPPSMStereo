...
parser.add_argument('--loadmodel', default='/home/fuy34/stereo_training/SPPPSM/usefull_res_sceneflow/jointTrain_sp4only_spw0.1_posw15/best_model.tar',
                    help='load model')
parser.add_argument('--logname', default='my_finetue_tst',
                    help='log name')
parser.add_argument('--savemodel', default='/home/fuy34/stereo_training/SPPPSM/useful_res_HRVS/',
                    help='save model')
...
# left_img_mb, right_img_mb, left_disp_mb, test_left_img, test_right_img, test_left_disp = ls.dataloader(args.datapath+'/middlebury/mb-ex/trainingF/')
...
all_left_img  = left_img_hr #left_img_mb * 8 +
all_right_img = right_img_hr #right_img_mb * 8 +
all_left_disp =  left_disp_hr #left_disp_mb * 8 +
...
def main():
    ...
    num_log_img = 4
    # train_epoch_max = 1e5
    log = logger.Logger(args.savemodel, name=args.logname , s_train = 'train')
    val_log = logger.Logger(args.savemodel, name=args.logname , s_train = 'val')
